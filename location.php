...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top">
        <div class="container">
            <a class="navbar-brand" href="./"><img src="./assets/img/fitness-hub.png" alt="img"
                    class="img-fluid logo_menu"> </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0 nav_barlist">
                    <li class="nav-item dropdown active">
                        <a class="nav-link text-dark nav_bar dropdown-toggle" href="#" id="navbarDropdownMenuLink"
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle text-dark nav_bar" href="#" id="navbarDropdown" role="button"
                ...
                <form class="d-flex nav_btn ">
                    ...
                    <a class="btn shadow-none  ms-2" href="#" type="submit"> <span class="me-2"><svg
    ...
    <section class="map_section">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <iframe
                        src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d29160.69036570754!2d85.34425599999999!3d23.992729599999997!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1710928045599!5m2!1sen!2sin"
