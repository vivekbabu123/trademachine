...
<body>
    ...
    <!-- haeder finish -->
    <!-- outdoor hero start -->
    <section class="outdoor_services">
            <div class="container">
                <div class="row">
    ...
    <!-- ourdoor fitness start -->
        <section class="outdoor_fitness">
            <div class="container">
                <div class="row pb-4">
                    <div class="col-12">
                        <div class="title_heading">
                            <h2 class="text-center">OUTDOOR FITNESS</h2>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-3">
                        <div class="mussles_outddor">
                            <img src="./assets/img/services/yellow_service.png" alt="img" class="img-fluid">
                        </div>
                        <div class="mussles_txt">
                            <h3>Muscle Fitness</h3>
                            <p>Build and strength, to perform challenging task</p>
                        </div>

                    </div>
                    <div class="col-md-3">
                    <div class="mussles_outddor">
                            <img src="./assets/img/services/yellow_service1.png" alt="img" class="img-fluid">
                        </div>
                    <div class="mussles_txt">
                            <h3>Core Fitness</h3>
                            <p>Steblizes the body during movement.</p>
                        </div>
                        </div>
                        <div class="col-md-3">
                        <div class="mussles_outddor">
                            <img src="./assets/img/services/yellow5.png" alt="img" class="img-fluid">
                        </div>
                        <div class="mussles_txt">
                            <h3>Cardio Fitness</h3>
                            <p>Keep heart and lungs functioning at optium levels.</p>
                        </div>
                        </div>
                        <div class="col-md-3">
                        <div class="mussles_outddor">
                            <img src="./assets/img/services/yellow_service3.png" alt="img" class="img-fluid">
                        </div>
                        <div class="mussles_txt">
                            <h3>Balance And Flexibility</h3>
                            <p>important for injury or fall prevention & muscle fitness.</p>
                        </div>
                        </div>
                </div>
            </div>
