...
<body>
    ...
    <!-- header finish -->
        <!-- prevemaintaince hero start -->
        <section class="prevemaintaince_services">
            <div class="container">
                <div class="row">
                    <div class="hero_titleservice text-center text-white">
                        <h1>Preventive & Equipment Maintenance</h1>
                    </div>
                </div>
            </div>
        </section>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <div class="maintain_andrepair_txt">
                        <h2>FITNESS EQUIPMENT PREVENTIVE MAINTENANCE AND REPAIR SERVICES</h2>
